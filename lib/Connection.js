...
var _ConnectionImpl = require('./impl/ConnectionImpl');

var _ConnectionImpl2 = _interopRequireDefault(_ConnectionImpl);
...
var Connection = function () {
  ...
  function Connection(options) {
    ...
    this.stub = new _ConnectionImpl2.default(options);
  }
  ...
  _createClass(Connection, [{
    ...
    key: 'executeRawQuery',
    value: function executeRawQuery(query) {
